...
import 'InsuranceInterested.dart';
import 'RejectedInsurance.dart';
        ...
        actions: [
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => InterestedInsurance()),
              );
            },
            child: Text(
              "Interested",
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => RejectedInsurance()),
              );
            },
            child: Text(
              "Not Interested",
